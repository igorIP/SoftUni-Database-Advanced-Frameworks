...
public final class Messages {
    ...
    public static final String INITIAL_SETUP = "01. Initial Setup";
    public static final String GET_VILLAINS_NAMES = "02. Get Villains' Names";
    ...
    public static final String ENTER_COUTRY = "Enter country name: ";
    public static final String NO_TOWN_NAMES = "No town names were affected.";
